        ...
        <Table className="border border-gray-300 w-full text-lg">
          <TableHeader>
            <TableRow className="bg-[var(--rv-secondary)] text-white">
              <TableHead className="px-4 py-3 text-black">Scheme Type</TableHead>
              <TableHead className="px-4 py-3 text-black">Trail 1st Year</TableHead>
              <TableHead className="px-4 py-3 text-black">Trail 2nd Year Onwards</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {commissionData.map((item, index) => (
              <TableRow key={index} className="border-b">
                <TableCell className="px-4 py-3 font-semibold text-black bg-[var(--rv-primary)]">{item.scheme}</TableCell>
                <TableCell className="px-4 py-3 text-black bg-[var(--rv-primary)]">{item.trail1}</TableCell>
                <TableCell className="px-4 py-3 text-black bg-[var(--rv-primary)]">{item.trail2}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
