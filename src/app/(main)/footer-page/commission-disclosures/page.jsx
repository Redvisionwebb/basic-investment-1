...
const CommissionDisclosurePage = () => {
    return (
        <div className={`${styles.footerpage} `}>
            ...
            <div className="px-4">
                <div className="max-w-screen-xl mx-auto section flex flex-col gap-5">

                    <h2 className="text-xl  font-bold text-[var(--primary)] ">Commission Disclosure under SEBI Circular SEBI/IMD/CIR No.4 /168230/09</h2>
                    ...
                    <Table className="border border-gray-300 w-full text-lg">
                        <TableHeader>
                            <TableRow className="bg-[var(--rv-secondary)] ">
